class SexyScaffoldGenerator < Rails::Generator::NamedBase
  ...
  def initialize(runtime_args, runtime_options = {})
    ...
    #    ActionView::Base::DEFAULT_TEMPLATE_HANDLER_PREFERENCE.include?(:haml) then
      @resource_generator = "sexy_scaffold"
  ...
  def manifest
    record do |m|
      ...
      for action in scaffold_views
        m.template(
          "sexy_scaffold:view_#{action}_haml.erb",
